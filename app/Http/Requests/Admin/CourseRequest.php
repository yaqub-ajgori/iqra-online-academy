...
class CourseRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'enrollment_ends_at' => 'nullable|date|after:enrollment_starts_at',
    ...
    public function attributes(): array
    {
        return [
            ...
            'preview_video_url' => 'প্রিভিউ ভিডিও',
            'price' => 'মূল্য',
            'currency' => 'মুদ্রা',
            ...
            'enrollment_starts_at' => 'ভর্তি শুরুর তারিখ',
            'enrollment_ends_at' => 'ভর্তি শেষের তারিখ',
            'status' => 'অবস্থা',
            'is_featured' => 'ফিচার্ড',
            'is_free' => 'বিনামূল্যে',
        ];
