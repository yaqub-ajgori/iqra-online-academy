...
<head>
    ...
    <title>Password Reset - Student | {{ config('app.name') }}</title>
</head>
                    ...
                    <tr>
                        <td align="center" style="padding-bottom: 24px;">
                            <div
                                ...
                                {{ config('app.name') }}</div>
                            <div style="font-size: 16px; color: #2d5a27; font-weight: 500;">Student Account Password
                                Reset</div>
                        </td>
                    </tr>
                    <tr>
                        <td style="font-size: 16px; color: #222; padding-bottom: 24px; text-align: center;">
                            You are receiving this email because we received a password reset request for your student
                            account.<br><br>
                            <a href="{{ $resetUrl }}"
