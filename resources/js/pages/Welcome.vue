    ...
    <div class="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
        ...
        <div class="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    <svg
                        class="w-full max-w-none trangray-y-0 text-[#F53003] opacity-100 transition-all duration-750 dark:text-[#F61500] starting:trangray-y-6 starting:opacity-0"
                        viewBox="0 0 438 104"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                    ...
                    <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                    >
                        <g class="trangray-y-0 opacity-100 transition-all delay-300 duration-750 starting:trangray-y-4 starting:opacity-0">
                            <path
                        ...
                        <g
                            ...
                            class="trangray-y-0 opacity-100 transition-all delay-300 duration-750 starting:trangray-y-4 starting:opacity-0"
                        >
                            <path
