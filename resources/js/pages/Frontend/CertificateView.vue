            ...
            <div class="certificate-container" id="certificate-content">
                ...
                <div class="certificate-content">
                    ...
                    <div class="recipient-section">
                        ...
                        <div class="achievement-text">has successfully completed the course with distinction</div>
                    </div>
        ...
        <div v-if="showShareModal" class="modal-overlay" @click.self="showShareModal = false">
            <div class="modal-content">
                ...
                <div class="share-link-container">
                    <input ref="shareLink" :value="shareUrl" readonly class="share-link-input" />
