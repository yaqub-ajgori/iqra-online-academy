  ...
  <AdminLayout>
    <div class="space-y-6">
      ...
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-2xl font-bold text-gray-900">New Course</h1>
          <p class="text-gray-600 mt-1">Create a new course for your academy</p>
        </div>
        <Link
...
const submit = () => {
  ...
  form.post(route('admin.courses.store'), {
    onSuccess: () => {
      success('কোর্স সফলভাবে তৈরি হয়েছে।')
    },
    onError: () => {
