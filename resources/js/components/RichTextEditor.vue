<template>
  <div class="space-y-2">
    ...
    <div class="border border-gray-300 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-[#2d5a27] focus-within:border-[#2d5a27]">
      <QuillEditor 
        ref="quillEditor"
    ...
    <p v-if="placeholder && !required" class="text-xs text-gray-500 mt-1">
      {{ placeholder }}
    </p>
