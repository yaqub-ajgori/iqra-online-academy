<template>
    <div class="progress-indicator">
        ...
        <div v-if="type === 'linear'" class="w-full">
            ...
            <div v-if="showLabel" class="mt-2 flex items-center justify-between">
        ...
        <div v-else-if="type === 'circular'" class="relative inline-block">
            <svg class="-rotate-90 transform" :width="size" :height="size">
                <!-- Background circle -->
                <circle cx="50%" cy="50%" :r="radius" stroke="currentColor" stroke-width="4" fill="transparent" class="text-gray-200" />
        ...
        <div v-else class="flex items-center justify-center">
            ...
            >
                <div class="h-full w-full rounded-full border-2 border-transparent border-t-current"></div>
            </div>
