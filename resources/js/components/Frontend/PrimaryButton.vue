...
const buttonClasses = computed(() => {
    ...
    const variantClasses = {
        ...
        accent: ['bg-[#d4a574] text-[#1f1f1f] border border-[#c49760]', 'hover:bg-[#c49760] hover:shadow-lg'],
        outline: ['border-2 border-[#5f5fcd] text-[#5f5fcd] bg-transparent', 'hover:bg-[#5f5fcd] hover:text-white hover:shadow-islamic'],
        ghost: ['text-[#5f5fcd] bg-transparent border border-transparent', 'hover:bg-gray-100 hover:text-[#4a4aa6]'],
        destructive: ['bg-red-600 text-white border border-red-600', 'hover:bg-red-700 hover:border-red-700 hover:shadow-lg'],
    };
    ...
    return [...baseClasses, sizeClasses[props.size], ...variantClasses[props.variant], radiusClasses, widthClasses].filter(Boolean).join(' ');
});
...
const iconClasses = computed(() => {
    ...
    return [...baseIconClasses, sizeIconClasses[props.size], positionClasses].join(' ');
});
</script>
